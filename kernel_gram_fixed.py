...
def gaussian_kernel_similarity(v1, v2, h=50):
...
def epsilon_neighbourhood(v1, v2, epsilon, h=50):
...
if __name__ == "__main__":
    ...
    MIN_WIDTH = 1  # The minimum kernel width of the range that you would like to test.
    MAX_WIDTH = 1  # The maximum kernel width of the range that you would like to test.
    ...
    for width in range(MIN_WIDTH, MAX_WIDTH+1, 1):
        ...
        scores = {"hit_rate": 0, "false_alarm": 0, "over_segmentation": 0, "F-score": 0, "R-score": 0, "num": 0}
