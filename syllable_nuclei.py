...
if __name__ == "__main__":
    ...
    for file in files:
        ...
        speechrate_dictionary = speech_rate(file[3])
        speechrate_dictionary.update({
            'dialect': file[0],
            'speaker': file[1],
            'utterance': file[2]
        })
    ...
    df.to_csv(r'C:\Users\Ian\Desktop\OUTPUT\speechrate_data.csv')